...
def _add_regularization_args(parser):
    ...
    group.add_argument('--muon-config-mode', type=str, default='blockwise',
                       choices=['blockwise', 'muonbp', 'snecv', 'pressure', 'muon'],
    ...
    group.add_argument('--muon-snecv-z-high', type=float, default=3.0,
                       help='z-score threshold for triggering full update in SNECV-Muon.')
    ...
    group.add_argument('--muon-pressure-full-update-interval', type=int, default=4,
                       help='Full update interval for pressure ablation Muon config mode.')
